...
def test_one_hop():
    q = { 'nodes': [ {"id": 'n0', "type": "disease", "curie": "MONDO:0005148"},
                     {"id": 'n1', "type": "chemical_substance" }],
          'edges': [ {'source_id': 'n1', 'target_id': 'n0', 'id':'ea'} ]
          }
    g = {
...
def test_three_hop():
    q = { 'nodes': [ {"id": 'n0', "type": "disease", "curie": "MONDO:0005148"},
                     {"id": 'n1', "type": "chemical_substance" },
                     {"id": 'n2', "type": "gene" },
                     {"id": 'n3', "type": "chemical_substance" }],
          'edges': [ {'source_id': 'n1', 'target_id': 'n0', 'id':'ea'},
                     {'source_id': 'n2', 'target_id': 'n1', 'id':'eb'},
                     {'source_id': 'n3', 'target_id': 'n2', 'id':'ec'} ]
          }
    g = {
         'nodes': [ {"id": "MONDO:0005148", "type": "disease"},
                    {"id": "CHEBI:17234", "type": "chemical_substance"},
